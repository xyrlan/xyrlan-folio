    ...
    return (
        ...
        <div>
            <ul className="flex gap-8 m-10">
                ...
                <li>
                   <a target='_blank' href="https://www.linkedin.com/in/pedro-lobato-xyrlan/"><motion.img initial={{ opacity: 0, scale: 0 }} transition={{ duration: 0.2 }} whileInView={{ opacity: 1, scale: 1 }} whileTap={{ scale: 0.8 }} className=' h-8 cursor-pointer' src='/images/linkedin-icon.svg' /></a> 
                </li>
                <li>
                   <a target='_blank' href="https://api.whatsapp.com/send/?phone=5561999936169"><motion.img initial={{ opacity: 0, scale: 0 }} transition={{ duration: 0.2 }} whileInView={{ opacity: 1, scale: 1 }} whileTap={{ scale: 0.8 }} className=' h-8 cursor-pointer' 
